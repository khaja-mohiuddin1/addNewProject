...
import { Button, message, Steps, theme, Breadcrumb } from "antd";
...
console.log("resourceIn Project",resourcesId )
  ...
  return (
    <>
      <div className="w-auto  m-0 p-5 bg-white">
        ...
        <Breadcrumb className=" mb-5"
          items={[
            ...
            {
              title: <a href="">Project Overview</a>,
            },
            {
              title: <a href="">Create Project</a>,
            },
          ]}
        />
      
        <h1 className="text-2xl font-semibold  pl-5">Create Project</h1>
      ...
      <div className="w-auto  overflow-hidden py-1 mt-6 bg-white">
        ...
        <div style={{ marginTop: 24 }}>
          {current < steps.length - 1 && (
            <Button
              ...
              className="ml-[50%]  mt-44 mb-12 px-5 py-1  justify-center items-center rounded-sm border border-blue-500 bg-blue-500 shadow-sm h-19 font-sans text-center text-white text-sm font-normal not-italic leading-3 flex-row-reverse"
            >
              Next
            </Button>
          )}
